...
INSERT INTO tb_lesson (title, subtitle, status, course_id) VALUES ('Aula 3 - Parametrização de superfícies', 'Nesta aula você aprenderá a parametrizar superfícies', 0, 1);
